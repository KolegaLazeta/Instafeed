...
<div class="row">
    <div class="col-8 offset-2 bg-light" style="border-radius: 25px">
        <h2 style="padding-left: 200px; padding-top:40px">Pracenje:</h2>
            ...
            @foreach($follows as $follower)
                @if(auth()->user()->following->contains($follower->id))
                            ...
                            <div class="pt-4 pb-3 text-dark" style="font-size: 20px; padding-left:200px; margin-bottom:10px ">
                                ...
                                <follow-button class="float-right" style="padding-right:200px" user-id="{{$follower->id}}" follows="{{ $follows }}"></follow-button>
